...
> **The hint was in the launch video, when he called it a fidget toy.** That is
> the whole origin of this.
...
in-app wording for the gesture is literally "Secret game".
...
The games were reported in the press for the first time on **2026-08-27**. They
were published here **thirty-one days earlier**, in GitHub-verified commits
anyone can still check.

| Date (UTC) | Commit | What happened |
|---|---|---|
| **2026-07-15** | — | The Codex Micro goes on sale. |
| **2026-07-17** | *(private working repo)* | The gesture found — as *interference*. Something kept hijacking the display during joystick work for upcoming arcade port I am working on, so it got characterised, worked around, and regression-tested away: the accumulating rotation, the "Keep circling" HUD, and the reset when the stick falls back to centre were observed. |
| **2026-07-26 09:47** | [`039e11e`](https://github.com/klack/codex-micro-easter-egg/commit/039e11e1f6) → [`fd6ec20`](https://github.com/klack/codex-micro-easter-egg/commit/fd6ec2039d) | **Published to the open web** — this repository. Working instructions, in public. |
...
| **2026-08-27 07:16** | — | RuntimeWire publishes, independently, and lands on the same distinctive figure. |
...
**Every commit in this repository carries GitHub's Verified badge.** Signed,
checkable by anyone, and dated a month before the press account of the same
behaviour.

Two things about this matter more than the dates.

**It was not a hunt.** The July work was not looking for an easter egg — it was
trying to stop one interfering with something else. And the starting point was
not a search of any kind; it was a line in the launch video about the thing
being a fidget toy.

**It was published, then deliberately un-published.** The instructions went up
on 2026-07-26 and came down three days later. That is the opposite of a claim
staked after the fact: it was out in the open a month before the press had it,
and pulled back down while it was still nobody else's.

**What is and is not claimed.** It does not follow that nobody else had ever
found it — plenty of people own this keyboard, and someone may have been idly
circling that stick since launch without writing it down. What is claimed is
narrower and checkable: found 2026-07-17, published 2026-07-26, and no other
public account of it existed until 2026-08-27.

**Corrections are welcome and will be credited.** If you own a Micro and
something here does not match what you see, that is worth more than the reading
it would replace.
